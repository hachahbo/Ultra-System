...
import { CalendarCheck, Calendar as CalendarIcon, Armchair } from "lucide-react";
    ...
    >
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="date" className="font-bold text-white">Date <span className="ml-2 inline-flex items-center rounded-md bg-red-500/10 px-2 py-1 text-[10px] font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Requis</span></Label>
          <Controller
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={cn(
                      "w-full justify-start text-left font-normal bg-[#18181A] border-white/5 hover:bg-[#202024] hover:text-white rounded-xl h-12 text-white px-4",
        ...
        <div className="space-y-2">
          <Label htmlFor="time" className="font-bold text-white">Heure <span className="ml-2 inline-flex items-center rounded-md bg-red-500/20 px-2 py-1 text-[10px] font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Requis</span></Label>
          <Input
            id="time"
            type="time"
            aria-invalid={!!errors.time}
            className={cn("bg-[#18181A] border-white/5 rounded-xl h-12 text-white px-4", errors.time && "border-destructive focus-visible:ring-destructive")}
            {...form.register("time")}
          />
      ...
      <div className="space-y-2">
        <Label htmlFor="party_size" className="font-bold text-white">Nombre de personnes <span className="ml-2 inline-flex items-center rounded-md bg-red-500/20 px-2 py-1 text-[10px] font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Requis</span></Label>
        <Input
          id="party_size"
          type="number"
          min={1}
          ...
          className={cn("bg-[#18181A] border-white/5 rounded-xl h-12 text-white px-4", errors.party_size && "border-destructive focus-visible:ring-destructive")}
      ...
      <div className="space-y-2">
        <Label htmlFor="customer_name" className="font-bold text-white">Nom <span className="ml-2 inline-flex items-center rounded-md bg-red-500/20 px-2 py-1 text-[10px] font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Requis</span></Label>
        <Input
          id="customer_name"
          autoComplete="name"
          aria-invalid={!!errors.customer_name}
          className={cn("bg-[#18181A] border-white/5 rounded-xl h-12 text-white px-4", errors.customer_name && "border-destructive focus-visible:ring-destructive")}
          {...form.register("customer_name")}
        />
        <FieldError message={errors.customer_name?.message} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="customer_phone" className="font-bold text-white">Téléphone <span className="ml-2 inline-flex items-center rounded-md bg-red-500/20 px-2 py-1 text-[10px] font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Requis</span></Label>
        <Input
          id="customer_phone"
          type="tel"
          inputMode="tel"
          ...
          className={cn("bg-[#18181A] border-white/5 rounded-xl h-12 text-white px-4", errors.customer_phone && "border-destructive focus-visible:ring-destructive")}
          {...form.register("customer_phone")}
        />
        <FieldError message={errors.customer_phone?.message} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="note" className="font-bold text-white">Note <span className="text-[#e2a84a]">(optionnel)</span></Label>
        <Textarea
          id="note"
          placeholder="Anniversaire, terrasse, chaise bébé…"
          className="bg-[#18181A] border-white/5 rounded-xl min-h-[100px] text-white p-4"
          {...form.register("note")}
        />
      </div>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild>
        <Button
          variant="outline"
          className={cn(
            "w-full justify-between font-normal bg-[#18181A] border-white/5 hover:bg-[#202024] hover:text-white rounded-xl h-12 text-white px-4",
